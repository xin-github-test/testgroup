...
<s:form   action="edit" namespace="/user" enctype="multipart/form-data">
    <%-- 修改的时候必须告诉服务器修改哪个用户，所以必须传一个id过去,使用hidden标签的时候注意，其中value的值并不是oGNL表达式，所以要将其用%{}括起来--%>
	...
	<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff">
				<s:password name="logonPwd" showPassword="true"/>
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff" colSpan="3">
				<s:checkboxlist  list="{'看电影','旅游','健身','购物','睡觉'}" name="hobby" value="hobby.split(', ')"></s:checkboxlist>
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff" colSpan="3">
				...
				<input id="showbtn" type="button" value="重新上传" onclick="showfile()"/>
				<input id="cancelbtn" type="button" value="取消上传" onclick="cancelfile()" style="display:none;"/>
				<script>
					function showfile() {
